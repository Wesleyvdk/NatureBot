...
export default {
  ...
  async execute(client: any, interaction: any, conn: any) {
    ...
    function StartGame(players: any) {
      let unoDeck = [];
      for (let k = 0; k <= 1; k++) {
        for (let j = 0; j <= 9; j++) {
          unoDeck.push(`Red ${j}`);
      ...
      if (players.length === 2) {
        ...
        for (let a = 0; a < 7; a++) {
          ...
          let card: string = unoDeck[index];
          unoDeck.splice(index, 1);
          player1.cards.push(card as never);
        }
        for (let a = 0; a < 7; a++) {
          let index = Math.floor(Math.random() * unoDeck.length);
          let card = unoDeck[index];
          unoDeck.splice(index, 1);
          player2.cards.push(card as never);
        }
      ...
      if (players.length === 3) {
        ...
        for (let a = 0; a < 7; a++) {
          ...
          let card = unoDeck[index];
          unoDeck.splice(index, 1);
          player3.cards.push(card as never);
        }
      ...
      if (players.length === 4) {
        ...
        for (let a = 0; a < 7; a++) {
          ...
          let card = unoDeck[index];
          unoDeck.splice(index, 1);
          player4.cards.push(card as never);
        }
